...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : delTwoEmptyStrings - удаление несколько пустых строк в коде VBA
...
ErrorHandler:
    Select Case Err.Number
        Case 91:
            Exit Sub
        Case Else:
            Debug.Print "Ошибка! в delTwoEmptyStrings" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "в строке " & Erl
...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : delEmptyTwoString - удаление двух пустых строк в коде VBA
'* Created    : 23-03-2023 10:12
'* Author     : VBATools
'* Copyright  : Apache License
