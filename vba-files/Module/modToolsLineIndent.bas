...
'*
'* PROCEDURES:
'*   RebuildModule       опирует модуль кода в массив дл€ перестроени€ и резервна€ копи€
'*   RebuildCodeArray   ќсновна€ процедура дл€ форматировани€ кода
'*   fnFindFirstItem    ѕроверьте, содержит ли строка кода какие-либо специальные служебные слова
'*   CheckLine          ƒобавить или удалить отступ
'*   ArrayFromVariant   ѕреобразование массива variant в массив string дл€ более быстрой обработки
'*   fnAlignFunction    ѕоиск где необходим отступ дл€ продолжени€
'*
'***************************************************************************
'*
'* CHANGE HISTORY
...
'ѕеременные дл€ хранени€ наших вариантов отступов
...
'ѕеременные дл€ хранени€ оперативной информации
...
ErrorHandler:
    If Err.Number <> 91 Then
        Debug.Print "ќшибка! в CutTab" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "в строке " & Erl
...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : ReBild - запуск инструмента форматировани€ кода VBA
...
ErrorHandler:
    Select Case Err.Number
        Case 91:
            Exit Sub
        Case Else:
            Debug.Print "ќшибка! в ReBild" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "в строке " & Erl
...
'* ByRef sName As String                         : им€ модул€
'* ByRef iStartLine As Long                      : начальна€ строка кода с которой начинаетс€ форматирование
'* ByRef iEndline As Long                        : конечна€ строка кода с которой начинаетс€ форматирование
'* ByRef iProgDone As Long                       : количество отступов
'* Optional ByRef mbEnableUndo As Boolean = True : возможность отменить изменени€
'*
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
Private Sub RebuildModule( _
    ...
    'Ёто позволило отменить? ≈сли это так, настройте наше хранилище
...
Public Sub RebuildCodeArray( _
    ...
    'ѕеременные, используемые дл€ кода отступа
...
'
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : fnFindFirstItem - поиск первого вхождени€ искомой строки кода
...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : ArrayFromVariant - преобразует массив в массив строк дл€ более быстрого сравнени€
