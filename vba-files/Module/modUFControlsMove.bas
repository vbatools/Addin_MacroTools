...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : MoveControl - изменение положения контрола на UserForms
'* Created    : 22-03-2023 15:58
'* Author     : VBATools
'* Copyright  : Apache License
'* Argument(s):                 Description
'*
'* ByRef cnt As control        : контрол
'* ByVal iVal As Integer       : значение перемещения
'* ByVal sComBoxText As String : тип перемещения
'*
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
