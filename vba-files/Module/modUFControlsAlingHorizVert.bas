...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : vbaCntAlingHoriz - Aligns controls horizontally
...
Public Sub vbaCntAlingHoriz()
    ...
    lColCnt = Application.InputBox("Enter number of columns", "Align by horizontal controls:", Type:=1)
    If lColCnt <= 0 Or lColCnt = False Then Exit Sub

    dSPACE = Application.InputBox("Enter spacing between controls", "Align by horizontal controls:", Type:=1)
...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : vbaCntAlingVert - Aligns controls vertically
'* Created    : 04-07-2022 14:39
'* Author     : VBATools
'* Copyright  : Apache License
'* * * * *
Public Sub vbaCntAlingVert()
    ...
    lColCnt = Application.InputBox("Enter number of rows", "Align by vertical controls:", Type:=1)
    If lColCnt <= 0 Or lColCnt = False Then Exit Sub

    dSPACE = Application.InputBox("Enter spacing between controls", "Align by vertical controls:", Type:=1)
    If TypeName(dSPACE) = "Boolean" Then Exit Sub
