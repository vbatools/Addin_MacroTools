...
Option Base 1
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Module     : K_AddNumbersLine - модуль создания номерации строк
...
ErrorHandler:
    Select Case Err.Number
        Case 91:
            Exit Sub
        Case Else:
            Debug.Print "Ошибка! в AddLineNumbers_" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "в строке " & Erl
            'Call WriteErrorLog("AddLineNumbers_")
    End Select
    Err.Clear
End Sub
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : RemoveLineNumbersPublic - удаление номеров строк кода
'* Created    : 22-03-2023 15:40
'* Author     : VBATools
'* Copyright  : Apache License
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
ErrorHandler:
    Select Case Err.Number
        Case 91:
            Exit Sub
        Case Else:
            Debug.Print "Ошибка! в RemoveLineNumbersPublic" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "в строке " & Erl
            'Call WriteErrorLog("RemoveLineNumbersPublic")
    End Select
    Err.Clear
End Sub
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : AddLineNumbers - создание номеров строк кода в модуле VBA
'* Created    : 22-03-2023 15:41
'* Author     : VBATools
'* Copyright  : Apache License
'* Argument(s):                                             Description
'*
'* ByVal vbCompObj As VBIDE.VBComponent                 : модуль VBA
'* ByVal LabelType As vbLineNumbers_LabelTypes          : тип пробелов для меток номеров
'* ByVal AddLineNumbersToEmptyLines As Boolean          : создание для пустых строх номера
'* ByVal AddLineNumbersToEndOfProc As Boolean           : создание номеров для конца процедур, функций
...
End Sub
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : IsProcEndLine - функция определения конца процедуры, функции или своиства
...
'*
'* ByVal vbCompObj As VBIDE.VBComponent : модуль VBA
'* ByVal lLine As Long                  : номер строки
'*
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
End Function
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : IndentProcBodyLinesAsProcEndLine - добавление номера в конце процедуры
...
'* ByVal vbCompObj As VBIDE.VBComponent        : модуль VBA
'* ByVal LabelType As vbLineNumbers_LabelTypes : тип пробелов для меток номеров
'* ByVal ProcEndLine As Long                   : номер строки конца процедуры
'* ByVal VBEXT As vbext_ProcKind               : тип процедуры
'*
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
        ...
        Do Until Not .Lines(j - 1, 1) Like "* _" And j <> bodyOfProcedure
            ...
            ElseIf LabelType = vbLabelTab Then
                If endOfProcedure < 1000 Then
                    ...
                    On Error GoTo 0
                Else
                    Debug.Print "Этот инструмент ограничен 999 строками кода для правильной работы."
                End If
            End If
            j = j + 1
        Loop
...
End Sub
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : RemoveLineNumbers - удаление всех номеров строк кода в модуле VBA
...
End Sub
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : RemoveOneLineNumber - удаление номера в начале строки
'* Created    : 22-03-2023 15:43
'* Author     : VBATools
'* Copyright  : Apache License
'* Argument(s):                                 Description
'*
'* ByVal aString As String                     : строка
'* ByVal LabelType As vbLineNumbers_LabelTypes : тип пробелов Tab или без
'*
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
End Function
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : HasLabel - проверка строки на содержание номера в начале строки
'* Created    : 22-03-2023 15:43
'* Author     : VBATools
'* Copyright  : Apache License
'* Argument(s):                                 Description
...
End Function
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : RemoveLeadingSpaces - удаляет все пробелы вначале строки
